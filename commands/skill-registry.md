...
| RestClient | `webclient.md` | Template `XxxClient` con `RestClient`, timeouts, `@Retry` Resilience4j, manejo de 4xx/5xx | Al integrar un servicio externo via HTTP |
...
2. **Abre el skill especifico** (`commands/xxx.md`) — contiene el template completo listo para adaptar.
...
*Skill Registry v2.2 · KLAP BYSF · Abril 2026 · 10 skills disponibles*
